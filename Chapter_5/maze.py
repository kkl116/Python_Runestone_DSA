...
def search_from(maze, start_row, start_column):
    ...
    # in turn (if needed)
    found = (
        search_from(maze, start_row - 1, start_column) #N
        or search_from(maze, start_row, start_column + 1) #E
        or search_from(maze, start_row + 1, start_column) #S
        or search_from(maze, start_row, start_column - 1) #W
    )
    if found:
        maze.update_position(start_row, start_column, PART_OF_PATH)
    else:
